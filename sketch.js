...
{  
  getBackgroundImg();
  bg = loadImage("acastro_190618_1777_cloud_gaming_0003.0.jpg");
  polygon_img = loadImage("polygon.png");
  blackBg = loadImage("online-gaming-1595435856946.png");
}
...
async function getBackgroundImg(){
  ...
  if(hour>=0600 && hour<=1900){
      bg = "online-gaming-1595435856946.png";
  }
  else{
      bg = "acastro_190618_1777_cloud_gaming_0003.0.jpg";
  }
